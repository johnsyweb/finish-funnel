...
- Multi-lane: lane count and lane length inputs; combined capacity vs peak; lane assignment with batch marker cards on lane-fill switches; finish-line backup when layout is configured; finisher spacing clamped to lane queue zone
